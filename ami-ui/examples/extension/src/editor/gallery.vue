<template>
  ...
  >
    ...
    <ami-dialog :modal-append-to-body="false" :visible.sync="copyDialogVisible">
      <ami-form ref="copyForm" :model="copyForm" :rules="copyFormRule">
        <ami-form-item label="主题名称" prop="name">
          <ami-input v-model="copyForm.name"></ami-input>
        </ami-form-item>
      </ami-form>
      <div slot="footer" class="dialog-footer">
        <ami-button @click="closeCopyForm">取消</ami-button>
        <ami-button type="primary" @click="copyToUser">确认</ami-button>
      </div>
    </ami-dialog>
  </div>
</template>
