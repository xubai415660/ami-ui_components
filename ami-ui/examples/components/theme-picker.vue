<template>
  <ami-color-picker
      ...
      v-model="theme"></ami-color-picker>
</template>
...
.theme-picker .ami-color-picker__trigger {
  vertical-align: middle;
}

.theme-picker-dropdown .ami-color-dropdown__link-btn {
  display: none;
}
</style>
  ...
  export default {
    ...
    watch: {
      theme(val, oldVal) {
        ...
        if (!this.chalk) {
          const url = `https://unpkg.com/ami-ui@${version}/lib/theme-chalk/index.css`;
