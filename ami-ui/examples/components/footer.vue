  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-main">
        ...
        <a href="" class="footer-main-link" target="_blank">{{ langConfig.changelog }}</a>
      ...
      <div class="footer-main">
        ...
        <a class="footer-main-link" href="https://segmentfault.com/t/ami-ui" target="_blank">SegmentFault</a>
