    ...
    <header class="header" ref="header">
      <div class="container">
        <h1><router-link :to="`/${ lang }`">
          ...
          <slot>
            <img
                src="../assets/images/ami-ui.svg"
                alt="element-logo"
                class="nav-logo">
            <img
              src="../assets/images/ami-ui-small.svg"
              alt="element-logo"
...
<!--          <li class="nav-item" v-show="isComponentPage">-->
          ...
          <!-- 版本选择器 -->
<!--          <li class="nav-item nav-versions" style="display: none" v-show="isComponentPage">-->
          ...
          <li class="nav-item nav-versions" style="display: none">
            <ami-dropdown
              ...
              <span>
                {{ version }}
                <i class="ami-icon-arrow-down ami-icon--right"></i>
              </span>
              <ami-dropdown-menu
                  slot="dropdown"
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      xhr.send();
      let primaryLast = '#0040D0';
      bus.$on(ACTION_USER_CONFIG_UPDATE, (val) => {
        let primaryColor = val.global['$--color-primary'];
        if (!primaryColor) primaryColor = '#0040D0';
