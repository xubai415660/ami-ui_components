...
<template>
  <div class="component-preview">
    ...
    <div class="color">
      <ami-row :gutter="12">
        <ami-col v-for="(color, key) in colorLine" :key="key" :span="4">
    ...
    <ami-row :gutter="12">
      ...
      <ami-col :span="9">
        ...
        <p
          ...
          With MySpace becoming more popular every day, there is the constant need to be different. There are millions
          of users. If MySpace layouts are chosen well, then you can enhance your profile a great deal.</p>
      </ami-col>
      <ami-col :span="9">
        ...
        <p
          ...
          touch with the central office via their notebooks. Computer hardware weaves itself through the fabric of our
          lives.</p>
      </ami-col>
    </ami-row>
  </div>
