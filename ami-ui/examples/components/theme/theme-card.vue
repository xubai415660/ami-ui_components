        ...
        <div class="info-center">
          <div class="title">
            ...
            <span class="right more" v-else>
              <ami-dropdown @command="actionClick">
                <i class="ami-icon-more"></i>
                <ami-dropdown-menu slot="dropdown">
                  <ami-dropdown-item command="rename">{{ getActionDisplayName('rename-theme') }}</ami-dropdown-item>
                  <ami-dropdown-item command="copy">{{ getActionDisplayName('copy-theme') }}</ami-dropdown-item>
                  <ami-dropdown-item
                      command="delete"
                      style="color: #F56C6C;"
                  >
...
import dateUtil from 'ami-ui/src/utils/date';
...
export default {
  ...
  computed: {
    ...
    mainColor() {
      return this.theme.global['$--color-primary'] || '#0040D1';
    },
    mainColor50() {
