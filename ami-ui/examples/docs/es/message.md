...
```html
<template>
  <ami-button :plain="true" @click="open">Show message</ami-button>
...
```html
<template>
  <ami-button :plain="true" @click="openCenter">Centered text</ami-button>
</template>
...
```html
<template>
  <ami-button :plain="true" @click="openHTML">Use HTML String</ami-button>
</template>
