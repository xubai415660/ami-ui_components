...
```html
<template>
  <ami-button type="text" @click="open">Click to open the Message Box</ami-button>
</template>
...
```html
<template>
  <ami-button type="text" @click="open">Click to open Message Box</ami-button>
</template>
