...
:::demo
```html
<ami-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></ami-tree>
...
<div class="buttons">
  <ami-button @click="getCheckedNodes">Récupération par noeud</ami-button>
  <ami-button @click="getCheckedKeys">Récupération par clé</ami-button>
  <ami-button @click="setCheckedNodes">Sélection par noeud</ami-button>
  <ami-button @click="setCheckedKeys">Sélection par clé</ami-button>
  <ami-button @click="resetChecked">Reset</ami-button>
</div>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <ami-button size="mini" type="text" on-click={ () => this.append(data) }>Ajouter</ami-button>
              <ami-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Supprimer</ami-button>
            </span>
          </span>);
      }
    }
