...
```html
<template>
  <ami-button :plain="true" @click="open">Afficher le message</ami-button>
  <ami-button :plain="true" @click="openVn">VNode</ami-button>
</template>
...
```html
<template>
  <ami-button :plain="true" @click="open2">success</ami-button>
  <ami-button :plain="true" @click="open3">warning</ami-button>
  <ami-button :plain="true" @click="open1">message</ami-button>
  <ami-button :plain="true" @click="open4">error</ami-button>
</template>
...
```html
<template>
  <ami-button :plain="true" @click="openCenter">Texte centré</ami-button>
</template>
...
```html
<template>
  <ami-button :plain="true" @click="openHTML">Utiliser du HTML</ami-button>
</template>
