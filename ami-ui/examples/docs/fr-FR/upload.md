...
<ami-upload
  ...
  :file-list="fileList">
  <ami-button size="small" type="primary">Cliquer pour envoyer</ami-button>
  <div slot="tip" class="ami-upload__tip">Fichiers jpg/png avec une taille inférieure à 500kb</div>
</ami-upload>
<script>
  export default {
    data() {
...
<ami-upload
  ...
  <div class="ami-upload__text">Déposer les fichiers ici ou<em>cliquez pour envoyer</em></div>
  <div class="ami-upload__tip" slot="tip">Fichiers jpg/png avec une taille inférieure à 500kb</div>
</ami-upload>
```
:::
...
<ami-upload
  ...
  action="https://jsonplaceholder.typicode.com/posts/"
  :auto-upload="false">
  <ami-button slot="trigger" size="small" type="primary">Choisir un fichier</ami-button>
  <ami-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">Envoyer au serveur</ami-button>
  <div class="ami-upload__tip" slot="tip">Fichiers jpg/png avec une taille inférieure à 500kb</div>
</ami-upload>
<script>
  export default {
