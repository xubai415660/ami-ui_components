...
```html
<ami-button type="text" @click="dialogVisible = true">Cliquez pour ouvrir le modal</ami-button>
...
<ami-dialog
  ...
  <span slot="footer" class="dialog-footer">
    <ami-button @click="dialogVisible = false">Annuler</ami-button>
    <ami-button type="primary" @click="dialogVisible = false">Confirmer</ami-button>
  </span>
</ami-dialog>
...
```html
<!-- Table -->
<ami-button type="text" @click="dialogTableVisible = true">Ouvrir un modal avec tableau</ami-button>

<ami-dialog title="Adresse d'expédition" :visible.sync="dialogTableVisible">
  <ami-table :data="gridData">
    <ami-table-column property="date" label="Date" width="150"></ami-table-column>
    <ami-table-column property="name" label="Nom" width="200"></ami-table-column>
    <ami-table-column property="address" label="Adresse"></ami-table-column>
  </ami-table>
</ami-dialog>

<!-- Form -->
<ami-button type="text" @click="dialogFormVisible = true">Ouvrir un modal avec formulaire</ami-button>

<ami-dialog title="Adresse d'expédition" :visible.sync="dialogFormVisible">
  <ami-form :model="form">
    <ami-form-item label="Nom de promotion" :label-width="formLabelWidth">
      <ami-input v-model="form.name" autocomplete="off"></ami-input>
    </ami-form-item>
    <ami-form-item label="Zones" :label-width="formLabelWidth">
      <ami-select v-model="form.region" placeholder="Sélectionnez une zone">
  ...
  <span slot="footer" class="dialog-footer">
    <ami-button @click="dialogFormVisible = false">Annuler</ami-button>
    <ami-button type="primary" @click="dialogFormVisible = false">Confirmer</ami-button>
  </span>
</ami-dialog>
...
```html
<template>
  <ami-button type="text" @click="outerVisible = true">Ouvrir le modal extérieur</ami-button>

  <ami-dialog title="Modal extérieur" :visible.sync="outerVisible">
    <ami-dialog
        width="30%"
    ...
    <div slot="footer" class="dialog-footer">
      <ami-button @click="outerVisible = false">Annuler</ami-button>
      <ami-button type="primary" @click="innerVisible = true">Ouvrir le modal intérieur</ami-button>
    </div>
  </ami-dialog>
</template>
...
```html
<ami-button type="text" @click="centerDialogVisible = true">Cliquez pour ouvrir le modal</ami-button>
...
<ami-dialog
  ...
  <span slot="footer" class="dialog-footer">
    <ami-button @click="centerDialogVisible = false">Annuler</ami-button>
    <ami-button type="primary" @click="centerDialogVisible = false">Confirmer</ami-button>
  </span>
</ami-dialog>
