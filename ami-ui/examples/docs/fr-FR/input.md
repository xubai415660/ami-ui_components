...
```html
<ami-input placeholder="Entrez quelque chose" v-model="input"></ami-input>
...
```html
<ami-input placeholder="Entrez votre mot de passe" v-model="input" show-password></ami-input>
...
<div class="demo-input-suffix">
  ...
  <ami-input
    ...
    suffix-icon="ami-icon-date"
    v-model="input1">
  </ami-input>
  <ami-input
    placeholder="Entrez du texte"
    prefix-icon="ami-icon-search"
    v-model="input2">
  </ami-input>
</div>
<div class="demo-input-suffix">
  ...
  <ami-input
    placeholder="Entrez une date"
    v-model="input3">
    <i slot="suffix" class="ami-input__icon ami-icon-date"></i>
  </ami-input>
  <ami-input
    placeholder="Entrez du texte"
    v-model="input4">
    <i slot="prefix" class="ami-input__icon ami-icon-search"></i>
  </ami-input>
</div>
...
```html
<div>
  <ami-input placeholder="Entrez quelque chose" v-model="input1">
    <template slot="prepend">Http://</template>
  </ami-input>
</div>
<div style="margin-top: 15px;">
  <ami-input placeholder="Entrez quelque chose" v-model="input2">
    <template slot="append">.com</template>
  </ami-input>
</div>
<div style="margin-top: 15px;">
  <ami-input placeholder="Entrez quelque chose" v-model="input3" class="input-with-select">
    <ami-select v-model="select" slot="prepend" placeholder="Choisir">
      <ami-option label="Restaurant" value="1"></ami-option>
      <ami-option label="Num. Commande" value="2"></ami-option>
      <ami-option label="Tel" value="3"></ami-option>
    </ami-select>
    <ami-button slot="append" icon="ami-icon-search"></ami-button>
  </ami-input>
</div>
...
<style>
  ...
  .input-with-select .ami-input-group__prepend {
...
```html
<ami-row class="demo-autocomplete">
  <ami-col :span="12">
...
<ami-autocomplete
  ...
  @select="handleSelect">
  <i
    class="ami-icon-edit ami-input__icon"
    slot="suffix"
