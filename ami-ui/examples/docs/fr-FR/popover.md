...
<template>
  <ami-popover
    ...
    <ami-button slot="reference">S'active au passage du curseur</ami-button>
  </ami-popover>
  ...
  <ami-popover
    ...
    trigger="click"
    content="this is content, this is content, this is content">
    <ami-button slot="reference">S'active en cliquant</ami-button>
  </ami-popover>
  ...
  <ami-button v-popover:popover>S'active au focus</ami-button>
  ...
  <ami-popover
    ...
    content="this is content, this is content, this is content"
    v-model="visible">
    <ami-button slot="reference" @click="visible = !visible">S'active manuellement</ami-button>
  </ami-popover>
</template>
...
<ami-popover
  ...
  <ami-button slot="reference">Cliquez pour activer</ami-button>
</ami-popover>
...
<ami-popover
  ...
  <div style="text-align: right; margin: 0">
    <ami-button size="mini" type="text" @click="visible = false">Annuler</ami-button>
    <ami-button type="primary" size="mini" @click="visible = false">Confirmer</ami-button>
  </div>
  <ami-button slot="reference">Supprimer</ami-button>
</ami-popover>
...
| transition | Animation de transition du popover. | string | — | ami-fade-in-linear |
