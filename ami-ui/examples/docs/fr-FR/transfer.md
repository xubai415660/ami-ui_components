...
<template>
  ...
  <div style="text-align: center">
    <ami-transfer
      ...
      @change="handleChange"
      :data="data">
      <ami-button class="transfer-footer" slot="left-footer" size="small">Opération</ami-button>
      <ami-button class="transfer-footer" slot="right-footer" size="small">Opération</ami-button>
    </ami-transfer>
