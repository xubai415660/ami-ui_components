...
<div class="buttons">
  <ami-button @click="getCheckedNodes">get by node</ami-button>
  <ami-button @click="getCheckedKeys">get by key</ami-button>
  <ami-button @click="setCheckedNodes">set by node</ami-button>
  <ami-button @click="setCheckedKeys">set by key</ami-button>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <ami-button size="mini" type="text" on-click={ () => this.append(data) }>Append</ami-button>
              <ami-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</ami-button>
            </span>
          </span>);
      }
    }
