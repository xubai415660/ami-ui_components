...
<ami-upload
  ...
  :file-list="fileList">
  <ami-button size="small" type="primary">Click to upload</ami-button>
  <div slot="tip" class="ami-upload__tip">jpg/png files with a size less than 500kb</div>
</ami-upload>
<script>
  export default {
    data() {
...
<ami-upload
  ...
  <div class="ami-upload__text">Drop file here or <em>click to upload</em></div>
  <div class="ami-upload__tip" slot="tip">jpg/png files with a size less than 500kb</div>
</ami-upload>
```
:::
...
<ami-upload
  ...
  action="https://jsonplaceholder.typicode.com/posts/"
  :auto-upload="false">
  <ami-button slot="trigger" size="small" type="primary">select file</ami-button>
  <ami-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">upload to server</ami-button>
  <div class="ami-upload__tip" slot="tip">jpg/png files with a size less than 500kb</div>
</ami-upload>
<script>
  export default {
