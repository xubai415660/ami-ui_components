...
```html
<ami-input placeholder="Please input" v-model="input"></ami-input>
...
```html
<ami-input placeholder="Please input password" v-model="input" show-password></ami-input>
...
```html
<div>
  <ami-input placeholder="Please input" v-model="input1">
    <template slot="prepend">Http://</template>
  </ami-input>
</div>
<div style="margin-top: 15px;">
  <ami-input placeholder="Please input" v-model="input2">
    <template slot="append">.com</template>
  </ami-input>
</div>
<div style="margin-top: 15px;">
  <ami-input placeholder="Please input" v-model="input3" class="input-with-select">
    <ami-select v-model="select" slot="prepend" placeholder="Select">
      <ami-option label="Restaurant" value="1"></ami-option>
      <ami-option label="Order No." value="2"></ami-option>
