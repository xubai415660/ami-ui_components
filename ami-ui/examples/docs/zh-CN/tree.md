...
<div class="buttons">
  <ami-button @click="getCheckedNodes">通过 node 获取</ami-button>
  <ami-button @click="getCheckedKeys">通过 key 获取</ami-button>
  <ami-button @click="setCheckedNodes">通过 node 设置</ami-button>
  <ami-button @click="setCheckedKeys">通过 key 设置</ami-button>
  <ami-button @click="resetChecked">清空</ami-button>
</div>
