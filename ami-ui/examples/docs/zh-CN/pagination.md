...
<div style="  background: #e6e6e6;margin-top: 10px">
  <ami-pagination
    background
...
<template>
  ...
  <div class="block">
    ...
    <ami-pagination
      ...
      :page-sizes="[100, 200, 300, 400]"
      :page-size="100"
      layout="totalPage, total, sizes, prev, pager, next, jumper"
      :total="400">
    </ami-pagination>
  </div>
</template>
...
| layout | 组件布局，子组件名用逗号分隔| String | `sizes`, `prev`, `pager`, `next`, `jumper`, `->`, `total`,`totalPage`, `slot` | 'prev, pager, next, jumper, ->, total, totalPage'  |
