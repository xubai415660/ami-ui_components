...
<ami-radio-group v-model="direction">
  <ami-radio label="ltr">从左往右开</ami-radio>
  <ami-radio label="rtl">从右往左开</ami-radio>
  <ami-radio label="ttb">从上往下开</ami-radio>
  <ami-radio label="btt">从下往上开</ami-radio>
</ami-radio-group>
...
```html
<ami-button type="text" @click="table = true">打开嵌套表格的 Drawer</ami-button>
<ami-button type="text" @click="dialog = true">打开嵌套 Form 的 Drawer</ami-button>
<ami-drawer
  title="我嵌套了表格!"
  :visible.sync="table"
  direction="rtl"
...
<ami-drawer
  ...
  <div class="demo-drawer__content">
    ...
    <div class="demo-drawer__footer">
      <ami-button @click="cancelForm">取 消</ami-button>
      <ami-button type="primary" @click="$refs.drawer.closeDrawer()" :loading="loading">{{ loading ? '提交中 ...' : '确 定' }}</ami-button>
    </div>
  </div>
</ami-drawer>
...
<ami-drawer
  ...
  size="50%">
  <div>
   <ami-button @click="innerDrawer = true">打开里面的!</ami-button>
   <ami-drawer
     title="我是里面的"
     :append-to-body="true"
     :before-close="handleClose"
