...
```html
<template>
  <ami-transfer v-model="value" :data="data"></ami-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <ami-transfer
      ...
      @change="handleChange"
      :data="data">
      <ami-button class="transfer-footer" slot="left-footer" size="small">操作</ami-button>
      <ami-button class="transfer-footer" slot="right-footer" size="small">操作</ami-button>
    </ami-transfer>
  </div>
