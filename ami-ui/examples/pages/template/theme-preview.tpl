...
<template>
  <div class="page-container page-theme-preview page-component__scroll ami-scrollbar" ref="themePreview">
    <section class="display">
      <ami-button type="text" icon="ami-icon-back" @click="navBack">
        <%= 1 >
      </ami-button>
