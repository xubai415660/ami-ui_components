<template>
  <transition
    ...
    <div
        v-show="visible"
        class="ami-time-range-picker ami-picker-panel ami-popper"
        :class="popperClass">
      <div class="ami-time-range-picker__content">
        <div class="ami-time-range-picker__cell">
          <div class="ami-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
              :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
              class="ami-time-range-picker__body ami-time-panel__content">
            <time-spinner
                ref="minSpinner"
        ...
        <div class="ami-time-range-picker__cell">
          <div class="ami-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
              :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
              class="ami-time-range-picker__body ami-time-panel__content">
            <time-spinner
      ...
      <div class="ami-time-panel__footer">
        <button
            type="button"
            class="ami-time-panel__btn cancel"
            @click="handleCancel()">{{ t('el.datepicker.cancel') }}
        </button>
        <button
            type="button"
            class="ami-time-panel__btn confirm"
            @click="handleConfirm()"
