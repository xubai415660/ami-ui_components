<template>
  <transition name="ami-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
        v-show="visible"
        class="ami-time-panel ami-popper"
        :class="popperClass">
      <div :class="{ 'has-seconds': showSeconds }" class="ami-time-panel__content">
        <time-spinner
            ref="spinner"
            @change="handleChange"
...
import {limitTimeRange, isDate, clearMilliseconds, timeWithinRange} from 'ami-ui/src/utils/date-util';
