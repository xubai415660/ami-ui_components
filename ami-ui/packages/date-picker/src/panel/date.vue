<template>
  <transition name="ami-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
        v-show="visible"
        class="ami-picker-panel ami-date-picker ami-popper"
        :class="[{
      ...
      <div class="ami-picker-panel__body-wrapper">
        ...
        <div class="ami-picker-panel__body">
          <div v-if="showTime" class="ami-date-picker__time-header">
            <span class="ami-date-picker__editor-wrap">
              <ami-input
            ...
            <span v-clickoutside="handleTimePickClose" class="ami-date-picker__editor-wrap">
              <ami-input
                  ref="input"
          ...
          <div
              :class="{ 'ami-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
              class="ami-date-picker__header"
              v-show="currentView !== 'time'">
            <button
                type="button"
                @click="prevYear"
                :aria-label="t(`el.datepicker.prevYear`)"
                class="ami-picker-panel__icon-btn ami-date-picker__prev-btn ami-icon-d-arrow-left">
            </button>
            <button
                type="button"
                @click="prevMonth"
                ...
                class="ami-picker-panel__icon-btn ami-date-picker__prev-btn ami-icon-arrow-left">
            </button>
            <span
                @click="showYearPicker"
                role="button"
                class="ami-date-picker__header-label">{{ yearLabel }}</span>
            <span
                @click="showMonthPicker"
                v-show="currentView === 'date'"
                role="button"
                class="ami-date-picker__header-label"
                :class="{ active: currentView === 'month' }">{{t(`el.datepicker.month${ month + 1 }`)}}</span>
            <button
                type="button"
                @click="nextYear"
                :aria-label="t(`el.datepicker.nextYear`)"
                class="ami-picker-panel__icon-btn ami-date-picker__next-btn ami-icon-d-arrow-right">
            </button>
            <button
                type="button"
                @click="nextMonth"
                ...
                class="ami-picker-panel__icon-btn ami-date-picker__next-btn ami-icon-arrow-right">
            </button>
          </div>

          <div class="ami-picker-panel__content">
            <date-table
                v-show="currentView === 'date'"
                @pick="handleDatePick"
      ...
      <div
          class="ami-picker-panel__footer"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, AmiInput, AmiButton
    },
