<template>
  <div :class="{ 'has-seconds': showSeconds }" class="ami-time-spinner">
    <template v-if="!arrowControl">
      <ami-scrollbar
          @mouseenter.native="emitSelectRange('hours')"
          @mousemove.native="adjustCurrentSpinner('hours')"
          class="ami-time-spinner__wrapper"
          wrap-style="max-height: inherit;"
          view-class="ami-time-spinner__list"
          noresize
          tag="ul"
          ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
          ...
          class="ami-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="ami-time-spinner__arrow ami-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="ami-time-spinner__arrow ami-icon-arrow-down"></i>
        <ul ref="hours" class="ami-time-spinner__list">
          <li
              class="ami-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="ami-time-spinner__arrow ami-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="ami-time-spinner__arrow ami-icon-arrow-down"></i>
        <ul ref="minutes" class="ami-time-spinner__list">
          <li
              class="ami-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="ami-time-spinner__arrow ami-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="ami-time-spinner__arrow ami-icon-arrow-down"></i>
        <ul ref="seconds" class="ami-time-spinner__list">
          <li
...
import {getRangeHours, getRangeMinutes, modifyTime} from 'ami-ui/src/utils/date-util';
import AmiScrollbar from 'ami-ui/packages/scrollbar';
import RepeatClick from 'ami-ui/src/directives/repeat-click';
