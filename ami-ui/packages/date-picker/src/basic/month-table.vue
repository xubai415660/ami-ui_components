<template>
  <table class="ami-month-table" @click="handleMonthTableClick" @mousemove="handleMouseMove">
    <tbody>
...
import {isDate, range, getDayCountOfMonth, nextDate} from 'ami-ui/src/utils/date-util';
import {hasClass} from 'ami-ui/src/utils/dom';
import {arrayFindIndex, coerceTruthyValueToArray, arrayFind} from 'ami-ui/src/utils/util';
