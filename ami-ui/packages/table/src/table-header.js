import Vue from 'vue';
import { hasClass, addClass, removeClass } from 'ami-ui/src/utils/dom';
...
export default {
        ...
        <thead class={ [{ 'is-group': isGroup, 'has-gutter': this.hasGutter }] }>
          {
            this._l(columnRows, (columns, rowIndex) =>
              ...
              >
                    ...
                    <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] }>
                      ...
                      }
                      {
                        column.filterable ? (<span
                          class="ami-table__column-filter-trigger"
                          on-click={ ($event) => this.handleFilterClick($event, column) }>
                          <i class={ ['ami-icon-arrow-down', column.filterOpened ? 'ami-icon-arrow-up' : ''] }></i>
                        </span>) : ''
                      }
                    </div>
                  </th>))
                ...
                {
                  this.hasGutter ? <th class="ami-table__cell gutter"></th> : ''
                }
              </tr>
            )
          }
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.ami-table__column-filter-trigger') || cell;
