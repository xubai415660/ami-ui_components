...
import AmiRadio from 'ami-ui/packages/radio';
import {isEqual} from 'ami-ui/src/utils/util';
...
export default {
  ...
  methods: {
    ...
    renderCheckIcon(h) {
      return (
        <i class="ami-icon-check ami-cascader-node__prefix"></i>
      );
    },

    renderLoadingIcon(h) {
      return (
        <i class="ami-icon-loading ami-cascader-node__postfix"></i>
      );
    },

    renderExpandIcon(h) {
      return (
        <i class="ami-icon-arrow-right ami-cascader-node__postfix"></i>
      );
    },
    ...
    renderContent(h) {
      ...
      return (
        <span class="ami-cascader-node__label">{vnode || node.label}</span>
      );
    }
  },
