<template>
  <label
      :class="[
      border && checkboxSize ? 'ami-checkbox--' + checkboxSize : '',
      ...
      :id="id"
  >
    <span class="ami-checkbox__input"
          :class="{
        'is-disabled': isDisabled,
        'is-checked': isChecked,
    ...
    >
      <span class="ami-checkbox__inner"></span>
      <input
          v-if="trueLabel || falseLabel"
          class="ami-checkbox__original"
          type="checkbox"
    ...
    <span v-if="$slots.default || label" class="ami-checkbox__label">
      <slot></slot>
