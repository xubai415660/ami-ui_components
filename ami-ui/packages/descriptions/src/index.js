...
import {isFunction} from 'ami-ui/src/utils/types';

export default {
  name: 'AmiDescriptions',
  components: {
  ...
  methods: {
    ...
    getRows() {
      const children = ((this.$slots.default || []).filter(vnode => vnode.tag &&
            vnode.componentOptions && vnode.componentOptions.Ctor.options.name === 'AmiDescriptionsItem'));
  ...
  render() {
    ...
    return (
      <div class="ami-descriptions">
        {
          (title || extra || $slots.title || $slots.extra)
            ? <div class="ami-descriptions__header">
              <div class="ami-descriptions__title">
                {$slots.title ? $slots.title : title}
              </div>
              <div class="ami-descriptions__extra">
        ...
        <div class="ami-descriptions__body">
          <table
            class={['ami-descriptions__table', {'is-bordered': border}, descriptionsSize ? `ami-descriptions--${descriptionsSize}` : '']}>
            {rows.map(row => (
