...
export declare class AmiDialog extends AmiUIComponent {
    /** Title of Dialog */
    title: string
  ...
  modal: boolean
    ...
    /** Whether to append modal to body Ami. If false, the modal will be appended to Dialog's parent Ami */
  ...
  center: boolean
    ...
    /** Whether to destroy Amis in Dialog when closed */
