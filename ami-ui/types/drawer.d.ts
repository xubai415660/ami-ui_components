...
/** Drawer Component */
export declare class AmiDrawer extends AmiUIComponent {
    ...
    /* Equivalent to `Dialog`'s modal-append-to-body attribute, determines whether the shadowing background should be inserted direct to DocumentBody Ami */
