...
export declare class AmiMessageBoxComponent extends Vue {
    title: string
    message: string
    type: MessageType
    iconClass: string
...
export interface AmiMessageBoxOptions {
  ...
  customClass?: string
    ...
    callback?: (action: MessageBoxCloseAction, instance: AmiMessageBoxComponent) => void

    /** Callback before MessageBox closes, and it will prevent MessageBox from closing */
    beforeClose?: (action: MessageBoxCloseAction, instance: AmiMessageBoxComponent, done: (() => void)) => void
...
export interface AmiMessageBoxShortcutMethod {
    (message: string, title: string, options?: AmiMessageBoxOptions): Promise<MessageBoxData>

    (message: string, options?: AmiMessageBoxOptions): Promise<MessageBoxData>
}

export interface AmiMessageBox {
    /** Show a message box */
    (message: string, title?: string, type?: string): Promise<MessageBoxData>

    /** Show an alert message box */
    alert: AmiMessageBoxShortcutMethod
    /** Show a confirm message box */
    confirm: AmiMessageBoxShortcutMethod
    /** Show a prompt message box */
    prompt: AmiMessageBoxShortcutMethod

    /** Show a message box */
    (options: AmiMessageBoxOptions): Promise<MessageBoxData>

    /** Set default options of message boxes */
    setDefaults(defaults: AmiMessageBoxOptions): void
