...
/** Rate Component */
export declare class AmiRate extends AmiUIComponent {
    /** Max rating score */
    max: number
  ...
  highThreshold: number
    ...
    /** Colors for icons. If array, it should have 3 Amis, each of which corresponds with a score level, else if object, the key should be threshold value between two levels, and the value should be corresponding color */
  ...
  disabledVoidColor: string
    ...
    /** Class names of icons. If array, it should have 3 Amis, each of which corresponds with a score level, else if object, the key should be threshold value between two levels, and the value should be corresponding class name */
